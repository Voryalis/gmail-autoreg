...
===================================================
____   ____                         .__  .__        
\   \ /   /__________ ___.__._____  |  | |__| ______
 \   Y   /  _ \_  __ <   |  |\__  \ |  | |  |/  ___/
  \     (  <_> )  | \/\___  | / __ \|  |_|  |\___ \ 
   \___/ \____/|__|   / ____|(____  /____/__/____  >
                      \/          \/             \/ 
...
arabic_first_names = [
    ...
    "Firas", "Zayd", "Taha", "Yasin", "Sakina", "Rasha", "Sufyan", "Nafisa", "Othman",
...
def save_email_to_file(email, password):
    with open("emails.txt", "a") as file:
        file.write(f"Gmail: {email}, Password: a6045357 {password}\n")
